...
Σε περίπτωση ομαδικής εργασίας, το όνομα του φακέλου έχει το ΑΜ μίας/ενός από την ομάδα και στο readme file μέσα στο φάκελο δίνονται τα στοιχεία όλων των μελών της ομάδας (όπως είναι το παράδειγμα με τον φάκελο P2012000).
