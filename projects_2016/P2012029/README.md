...
Επειδή το module sentiment αποτελεί κρίσιμο κομμάτι και εργαλείο της εφαρμογής,είναι καλό να περιγραφεί η λειτουργικότητα του.Η δημιουργία του έχει γίνει με την γλώσσα JavaScript.Οι δημιουργοί,αυτού του διάσημου module έχουν εισάγει χειροκίνητα,πάνω από 1500 λέξεις,όπως(happy,very happy,unhappy,very unhappy) σε μια κλίμακα από το 
