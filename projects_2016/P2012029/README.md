...
Για την ανάπτυξη της συγκεκριμένης εφαρμογής,απαιτήθηκε η μελέτη και η κατανόηση της λειτουργίας πολλών παρόμοιων εφαρμογών.Εφαρμογές πο οποίος περισσότερες είναι εραστιτεχνικές,δηλαδή κάποια project στο Github αλλά και πιο επαγγελματικές.Για αυτό σκόπιμο είναι να γίνει μια μικρή αναφορά σε αυτές:
