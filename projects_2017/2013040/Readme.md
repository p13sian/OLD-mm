...
ΔΙΑΓΡΑΜΜΑ ΛΕΙΤΟΥΡΓΙΑΣ ΣΥΣΤΗΜΑΤΟΣ : 1)Τροποποίηση του παραθύρου που τρέχει ο κώδικας στο processing όσο αφορά το μέγεθος . 2)Επεξεργασία του χρώματος στο default background. 3)Αλλαγή στον πηγαίο κώδικα με μετατροπές στην ταχύτητα και στο μοτίβο του σχήματος (αλλαγή στην έλλειψη). 4) Προσθήκη επεξεργασμένου κώδικα από άλλο παράδειγμα του processing από την κατηγορία Motion-Bounce. 5) Παρατήρηση συνδυασμού μοτίβων, μετατροπής του αρχικού και συλλογή στιγμιοτύπων.
