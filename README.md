...
* Interactive visualization: [Processing](http://www.processing.org) or [D3JS](https://d3js.org/) visualization, [Public APIs](https://github.com/toddmotto/public-apis), [Twitter & Weather Visualisation](https://github.com/courses-ionio/mm/blob/master/projects_2017/project_twitterWeatherVisualisation.md), [Facebook App & D3](https://drive.google.com/open?id=0B-sS9CKzUYw7cXZZLUh1TTlMRXc), Demos: [Processing Exhibition](https://processing.org/exhibition/), [Information aesthetics](http://infosthetics.com/)  [Rocketgraph](https://rocketgraph.com/marketplace), [WeFeelFine](http://wefeelfine.org/), [TenByTen](TenByTen)
